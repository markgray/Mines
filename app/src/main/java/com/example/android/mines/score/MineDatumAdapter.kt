...
import com.example.android.mines.TextItemViewHolder
import com.example.android.mines.database.MinesDatum
import com.example.android.mines.formatMinesDatum

class MineDatumAdapter: RecyclerView.Adapter<TextItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TextItemViewHolder, position: Int) {
        ...
        holder.textView.text = formatMinesDatum(item)
    }
}